...
public final class InGameInputHandler extends ClientInputHandler {
     ...
     */
    private void error(final ErrorMessage message) {
        invokeLater(new Runnable() {
            public void run() {
     ...
     */
    private void highScore(final HighScoreMessage message) {
        final Game game = getGame();
     ...
     */
    private void monarchAction(final MonarchActionMessage message) {
        final Game game = getGame();
