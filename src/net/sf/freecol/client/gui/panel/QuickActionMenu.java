...
public final class QuickActionMenu extends JPopupMenu {
    ...
    private boolean addBoardItems(final UnitLabel unitLabel, Location loc) {
        ...
        for (Unit unit : loc.getUnits()) {
            if (!unit.isCarrier() || !unit.canCarryUnits() || !unit.canAdd(tempUnit)
    ...
    private JMenuItem createRoleItem(final UnitLabel unitLabel,
        ...
        case 1:
            ...
            break;
        default:
            change = AbstractGoods.findPositive(need);
            break;
        }
        ...
        for (Unit unit : europe.getUnits()) {
            ...
            menuItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent ae) {
                    ...
                    igc.buyGoods(ag.getType(), ag.getAmount(), u);
                }});
            this.add(menuItem);
            added = true;
        }
