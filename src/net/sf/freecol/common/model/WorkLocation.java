...
public abstract class WorkLocation extends UnitLocation
        ...
        public static final Comparator<Suggestion> descendingAmountComparator
            = new Comparator<Suggestion>() {
                public int compare(Suggestion a, Suggestion b) {
                    ...
                    diff = GoodsType.goodsTypeComparator.compare(
                        a.getGoodsType(), b.getGoodsType());
                    if (diff != 0) return diff;
                    return a.getNewUnitType().compareTo(b.getNewUnitType());
                }};
    ...
    public java.util.Map<Unit, Suggestion> getSuggestions() {
        ...
        for (Unit u : transform(getUnitList(), isNull(Unit::getTeacher))) {
    ...
    public boolean produces(GoodsType goodsType) {
        return productionType != null && productionType.hasOutput(goodsType);
    }
    ...
    public boolean hasOutputs() {
        return productionType != null && productionType.hasOutputs();
    }
    ...
    public int getUnitProduction(Unit unit, GoodsType goodsType) {
        ...
        return Math.max(0,
            (int)FeatureContainer.applyModifiers(
                    getBaseProduction(this.productionType, goodsType, unitType),
                    getGame().getTurn(),
